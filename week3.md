...
선택한 퀘스트: Quest 2. 남은 기간 멘탈케어를 위한 AI 상담소 <br/>
이유: 매일 바쁘게 미션을 수행하다보면 체력적으로 정신적으로 지친다. 이 때 AI가 나를 공감해주고 위로해준다면 네부캠 생활을 롱런할 수 있지 않을까라는 생각에 선택하게되었다.
...
여자친구와 다투면서 마음이 무거워짐
감정이 계속 남아 있어 일에 몰입하기 어려움

### 3. 고민/걱정거리

변화된 감정 상태로 인해 미션에 제대로 집중하지 못하고 있음
이 상태로 과연 마지막까지 미션을 잘 마무리할 수 있을지 걱정됨

### 4. 필요한 것

감정을 정리하고 집중력을 회복할 수 있는 조언
마음을 가볍게 하는 위로

### AI의 위로와 조언

관계에서의 다툼은 에너지를 많이 소모하게 하고, 그 여파는 일에도 영향을 미칩니다. 하지만 감정을 무리해서 억누르기보다, 잠시 시간을 내어 정리하는 것이 오히려 회복을 빠르게 합니다. 오늘은 미션 전체가 아니라 ‘작은 단위 목표’ 하나만 정해 실행해 보세요. 완벽한 하루를 만들 필요 없이, 작은 성취로 자신감을 되찾으면 내일은 더 잘 할 수 있습니다. 그리고 여자친구와의 대화는 감정이 조금 가라앉은 후에 차분히 시도하는 것이 좋습니다.

</details>

- 해야 할 일을 작은 목표로 줄여 생각하니 부담이 덜해졌다.
- 감정을 억누르기보다 정리하는 시간을 갖는 것이 필요하다는 점을 깨달았다.
- AI한테 감정적인 위로와 피드백을 받는게 신선했다.

</details>

### J139 - 서준익

선택한 퀘스트: Quest 3. AI가 골라준 오늘의 뉴스를 슬랙에 공유하기 <br/>
이유: 요즘 바빠서 뉴스를 못 보고 살고 있는데 AI가 정해준 중요한 뉴스들을 확인하면서 시사/경제 에 대해서 간단하게 알고 가고 싶어서 선택하게 되었다. 또한 뉴스를 보는 습관을 길러보고 싶어서 선택하게 되었다.

### J180 - 이다은

선택한 퀘스트: Quest 2. 남은 기간 멘탈케어를 위한 AI 상담소 <br/>
이유: "사람들은 혼자 보는 일기장에도 거짓말을 씁니다.” 라는 문장이 있다. 이를 생각해보았을 때 나 자체를 객관적으로 바라보고 있었나 생각이 들었고, 나의 상태를 숨김없이 AI에게 설명해보고 실제 상태를 정검해보고 싶어서 선택하게 되었다.

### J277 - 최현호

선택한 퀘스트 : Quest 3. AI가 골라준 오늘의 뉴스를 슬랙에 공유하기 <br/>
이유 : 세상과 너무 멀어진다. 뉴스라도 보면서 인생을 동기화시키자.
